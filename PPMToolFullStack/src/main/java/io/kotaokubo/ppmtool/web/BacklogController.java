...
import io.kotaokubo.ppmtool.services.ProjectTaskService;
...
public class BacklogController {
    ...
    public ResponseEntity<?> updateProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id, @Valid @RequestBody ProjectTask projectTask, BindingResult result, Principal principal) {
